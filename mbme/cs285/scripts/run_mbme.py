...
def main():
    ...
    parser.add_argument('--env_name', type=str, default='marathon-hopper-v0') #reacher-cs285-v0, ant-cs285-v0, cheetah-cs285-v0, obstacles-cs285-v0
    parser.add_argument('--ep_len', type=int, default=1000)
    parser.add_argument('--exp_name', type=str, default='debug')
    parser.add_argument('--n_iter', '-n', type=int, default=20000)

    parser.add_argument('--ensemble_size', '-e', type=int, default=3)
    parser.add_argument('--mpc_horizon', type=int, default=10)
    parser.add_argument('--mpc_num_action_sequences', type=int, default=30)

    parser.add_argument('--add_sl_noise', '-noise', action='store_true', default=True)
    parser.add_argument('--num_agent_train_steps_per_iter', type=int, default=1)
    parser.add_argument('--train_steps_initial', type=int, default=1000)
    parser.add_argument('--batch_size_initial', type=int, default=3000) #(random) steps collected on 1st iteration (put into replay buffer)
    parser.add_argument('--batch_size', '-b', type=int, default=1) #8000) #steps collected per train iteration (put into replay buffer)
    ...
    parser.add_argument('--scalar_log_freq', type=int, default=2000) #-1 to disable
